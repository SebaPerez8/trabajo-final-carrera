...
Partial Public Class ABM_productosListar

    '''<summary>
    '''Control formProductosListar.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents formProductosListar As Global.System.Web.UI.HtmlControls.HtmlForm
