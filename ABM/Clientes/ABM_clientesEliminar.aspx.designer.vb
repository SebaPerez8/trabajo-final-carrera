...
Partial Public Class ABM_clientes_eliminar2

    '''<summary>
    '''Control formClientesEliminar.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents formClientesEliminar As Global.System.Web.UI.HtmlControls.HtmlForm
