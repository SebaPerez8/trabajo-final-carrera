...
Partial Public Class ABM_proveedoresListar

    '''<summary>
    '''Control formProveedoresListar.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents formProveedoresListar As Global.System.Web.UI.HtmlControls.HtmlForm
